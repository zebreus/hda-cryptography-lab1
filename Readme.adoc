...
You can get a temporary shell with the `permutate` program by running `nix shell github:zebreus/hda-cryptography-lab1` with [nix](https://determinate.systems/posts/determinate-nix-installer/).
